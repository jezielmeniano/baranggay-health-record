...
<body>
                ...
                <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>";
                                echo "<button class='view-button' onclick='viewPatient(" . $row['patient_id'] . ")'>View</button>";
                                echo "<span style='margin-right: 10px;'></span>"; 
                                echo "<button class='edit-button' onclick='editPatient(" . $row['patient_id'] . ")'>Edit</button>";
                                echo "<span style='margin-right: 10px;'></span>"; 
                                echo "<button class='delete-button' onclick='deletePatient(" . $row['patient_id'] . ")'>Delete</button>";
                                echo "</td>";
                                echo "</tr>";
    ...
    <script>
         function addpatients(patientId) {
        window.location.href = "info.php?patientId=" + patientId;
        }

        function viewPatient(patientId) {
        window.location.href = "view-info.php?patientId=" + patientId;
        }
    ...
    if (confirmDelete) {
        window.location.href = "delete-record.php?patientId=" + patientId;
    } else {
        return false;
    }
}
